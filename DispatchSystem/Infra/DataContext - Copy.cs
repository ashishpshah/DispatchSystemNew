...
namespace Dispatch_System
{
	public static class DataContext
	{
		...
		public static DataTable ExecuteQuery(string sqlquery)
		{
			...
			{
				//if (AppHttpContextAccessor.IsLogActive) LogService.ErrorWrite("Error | DataBase | ExecuteQuery | " + sqlquery + " | " + ex.Message, ex);
		...
		public static bool ExecuteNonQuery(string query, List<OracleParameter> parameters = null)
		{
			...
			{
				//if (AppHttpContextAccessor.IsLogActive) LogService.ErrorWrite("Error | DataBase | ExecuteNonQuery | " + query + " | " + strParams + " | " + ex.Message, ex);
				return false;
			}
		}
		...
		public static bool ExecuteNonQuery_Delete(string query, OracleParameter[] parameters = null)
		{
			...
			{
				//if (AppHttpContextAccessor.IsLogActive) LogService.ErrorWrite("Error | DataBase | ExecuteDeleteQuery | " + query + " | " + ex.Message, ex);
				return false;
			}
		}
		...
		public static string ExecuteInsertQuery(string query)
		{
			using (OracleConnection con = new OracleConnection(_connectionString_Oracle))
			{
				...
				catch (Exception ex) { /*if (AppHttpContextAccessor.IsLogActive) LogService.ErrorWrite("Error | DataBase | ExecuteInsertQuery | " + query + " | " + ex.Message, ex);*/ con.Close(); }
			}
		...
		public static string ExecuteFunction(string strFunction, List<OracleParameter> parameters = null)
		{
			...
			using (OracleConnection objConn = new OracleConnection(_connectionString_Oracle))
			{
				...
				{ /*if (AppHttpContextAccessor.IsLogActive) LogService.ErrorWrite("Error | DataBase | ExecuteFunction | " + strFunction + " | " + strParams + " | " + ex.Message, ex);*/ }
