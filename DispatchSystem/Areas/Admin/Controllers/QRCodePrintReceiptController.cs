...
{
	[Area("Admin")]
	public class QRCodePrintReceiptController : BaseController<ResponseModel<QRCodeGeneration>>
	{
		...
		public ActionResult GetData_QrCodeReq(JqueryDatatableParam param)
		{
			...
			oParams.Add(new OracleParameter("P_SITE_ID", OracleDbType.Int64) { Value = VendorSiteName == "" || VendorSiteName == "null" ? null : Convert.ToInt32(VendorSiteName) });
			...
			var ds = DataContext.ExecuteStoredProcedure_DataSet("PC_REPORT_QR_CODE_PRINT_RECEIPT", oParams);
