	...
	public class HomeController : BaseController<ResponseModel<LoginViewModel>>
	{
		...
		public IActionResult SyncBatch()
		{
			try
			{
				...
				Write_Log(Environment.NewLine + $"File Processing Completed at {DateTime.Now.ToString("MM/dd/yyyy hh:mm:ss tt").Replace("-", "/")}" + Environment.NewLine + Environment.NewLine, logFilePath);
