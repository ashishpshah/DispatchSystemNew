...
namespace Dispatch_System
{
	public class LoginViewModel
	{
		...
		public int TodayGeneration { get; set; }
		public int TodayRecevied { get; set; }
		public int RawMaterial { get; set; }
		public int VendorPo { get; set; }
		public int ScrapSo { get; set; }
	}
	public class VendorLoginViewModel
	{
		[Required(ErrorMessage = "Please enter Vendor Code.")] public string VendorCode { get; set; }
		[Required(ErrorMessage = "Please enter Vendor Site.")] public string VendorSite { get; set; }
		[Required(ErrorMessage = "Please enter password.")] public string Password { get; set; }
		public long PlantId { get; set; }
